...
/**
 * A class that constructs a status bar. Status bars usually display status
...
public class StatusBar extends JPanel
{
  ...
  /**
   * Constructs a <code>StatusBar</code> object with a single section.
   *
  ...
  /**
   * Constructs a <code>StatusBar</code> object with one or more sections.
   *
   ...
   *
   * @param pos a zero-based section position
   * @param value the value associated with the specified position
   */
